...
- [~] Compiled `.class` header inventory with cited classfile major versions and known Java mappings; JAR/WAR/EAR archive and bytecode-reference traversal remain pending
