...
public final class LegacyHttpResponseStructuredTest {
    public static void main(String[] args) {
        ...
        LegacyHttpResponse response = new LegacyHttpResponse("https://example.com", 200, "OK", headers, new byte[] {0, 1, 2}, null);
        if (!"https://example.com".equals(response.getFinalUrl())) throw new AssertionError("final URL was not retained");
        if (!"OK".equals(response.getStatusMessage())) throw new AssertionError("response status message was not retained");
